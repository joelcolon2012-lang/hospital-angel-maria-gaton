...
import { Activity, AlertTriangle, Plus, X, Heart, Wind, Thermometer, ShieldAlert, Save, Download, Check, Trash2 } from 'lucide-react';
...
export const TriageVitalsTab: React.FC<Props> = ({ patient, onUpdateVitals }) => {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* Disclaimer permanent badge */}
      <div className="bg-slate-100 text-slate-600 p-2.5 rounded-xl text-xs border border-slate-200">
        <strong>Nota de referencia:</strong> Los rangos anormales se resaltan visualmente para soporte del médico, pero no constituyen diagnóstico definitivo automatizado.
      </div>
